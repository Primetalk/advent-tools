...
class Day24ParserTest extends BaseTest {

  behavior of "Day24ParserTest"

  it should "parseGroup" in {
    import Day24Parser._
    parseGroup("115 units each with 10354 hit points (immune to fire, radiation, bludgeoning) with an attack that does 788 cold damage at initiative 2") shouldBe
      GroupOfUnits(115, 10354, Cold, 788, Seq(Fire, Radiation, Bludgeoning), Seq(), 2)
    parseGroup("3389 units each with 6734 hit points with an attack that does 19 cold damage at initiative 18") shouldBe
      GroupOfUnits(3389, 6734, Cold, 19, Seq(), Seq(), 18)
  }

  it should "parseArmies" in {
    import Day24Parser._

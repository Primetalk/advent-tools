...
/**
  ...
  *
  * Your puzzle answer was 4968512.
  * --- Part Two ---
  *
...
object Day2025 {
  ...
  val cardPublicKey = BigInt(10604480)
  val doorPublicKey = BigInt(4126658)

  val base = BigInt(7L)
  val modulo = BigInt(20201227L) // prime number
  implicit val field: ModuloField = ModuloField(modulo)

  // subjectNumber = 7 ^ loopSize1 % modulo
  // second = subjectNumber ^ loopSize2 % modulo
  // enc = 7^ (loopSize1*loopSize2) %modulo
  // public1 = 7 ^ loopSize1 % modulo
  // public2 = 7 ^ loopSize2 % modulo
  //
  // loopSize1 = log_7(public1)
  // enc = public2 ^ loopSize1
  // 13376487
  lazy val answer1: BigInt = {
    val loopSize1 = cardPublicKey.log_%(base)
    doorPublicKey ^% loopSize1
  }

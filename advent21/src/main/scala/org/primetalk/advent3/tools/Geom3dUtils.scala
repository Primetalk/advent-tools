...
object Geom3dUtils:
  ...
  type Matrix4 = IArray[IArray[Int]]
  ...
  def Matrix4(t: TMatrix4): Matrix4 = 
      IArray(
        IArray.unsafeFromArray(t._1.toList.toArray[Int]),
        IArray.unsafeFromArray(t._2.toList.toArray[Int]),
        IArray.unsafeFromArray(t._3.toList.toArray[Int]),
        IArray.unsafeFromArray(t._4.toList.toArray[Int])
      )

  extension (a: IArray[Int])
   
    def *(b: IArray[Int]): Int =
      a.zip(b).map(p => p._1*p._2).sum
    
    def toTuple4: (Int, Int, Int, Int) =
      (a(0), a(1), a(2), a(3))
  ...
  type Quaternion = (Int, Int, Int, Int)

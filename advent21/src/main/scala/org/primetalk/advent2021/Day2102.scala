...
/**
  ...
  */
object Day2102 extends Utils:

  val lines = readResourceLines("day02.txt")
  def parseLine(line: String): (Int, Int) = line match {
    case s"forward $deltaX" => (deltaX.toInt, 0)
    case s"down $deltaY" => (0, deltaY.toInt)
    case s"up $deltaY" => (0, -deltaY.toInt)
  }
